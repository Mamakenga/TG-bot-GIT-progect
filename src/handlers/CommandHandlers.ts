...
💙 Помни: просить помощи - это сила, а не слабость.`, {
  ...
  private getPersonalizedRecommendation(q1: string, q2: string, q3: string): any {
    ...
    // Если в основном первые ответы (tired, support, understood)
    if ((q1 === 'tired' && q2 === 'support') || q3 === 'understood' || q1 === 'tired') {
      return {
    ...
    if (q1 === 'critic' || (q2 === 'direction' && q1 === 'critic')) {
      return {
    ...
    // Если просто хочется расти дальше
    return {
