        ...
        if (!dayCompleted) {
          ...
          if (currentDay === 7) {
            ...
            const finalMessage = 
              ...
              `Если ты хочешь:\n` +
              `— Продолжить путь к себе глубже,\n` +
              `— Разобраться с тревожностью, самооценкой, границами,\n` +
              `— Научиться по-настоящему заботиться о себе, не срываясь —\n` +
              `👉 Я приглашаю тебя дальше.\n\n` +
              
              `У нас есть:\n` +
              `📘 Тренинги по важным темам\n` +
              `🤝 Индивидуальные консультации\n` +
              `💬 Поддерживающее сообщество\n\n` +
              
              `Ты не одна. И тебе не нужно всё делать самой.\n` +
              `Если ты чувствуешь отклик — я рядом.\n\n` +
