...
💙 Помни: просить помощи - это сила, а не слабость.`, {
  ...
  private getPersonalizedRecommendation(q1: string, q2: string, q3: string): any {
    // Логика определения рекомендации
    
    if ((q1 === 'tired' && q2 === 'support') || q3 === 'understood') {
      return {
        text: `💆 **Индивидуальная консультация**\n\nПо твоим ответам видно, что тебе сейчас нужна бережная поддержка и понимание. Индивидуальная работа поможет:\n\n• Разобрать, что сейчас происходит\n• Найти внутренние ресурсы\n• Получить персональную поддержку\n• Двигаться в своём темпе\n\nЭто безопасное пространство только для тебя.`,
        button: 'Узнать об индивидуальной работе',
        action: 'recommend_individual'
      };
    }
    
    if (q1 === 'critic' || (q2 === 'direction' && q3 === 'forward')) {
      return {
        text: `🧭 **Курс "Тихий ум"**\n\nТы готова разобраться с внутренним критиком и обрести направление. Этот курс для тебя, если хочешь:\n\n• Остановить внутреннюю гонку\n• Повысить самооценку\n• Научиться управлять тревогой\n• Найти баланс и опору в себе\n\nСтруктурированный подход с конкретными инструментами.`,
        button: 'Узнать о курсе "Тихий ум"',
        action: 'recommend_course_mind'
      };
    }
    
    if (q1 === 'identity' || (q2 === 'connection' && q3 === 'safe')) {
      return {
        text: `🔎 **Групповая программа "Кто я?"**\n\nТебя тянет к глубокому исследованию себя в безопасном пространстве. Программа поможет:\n\n• Исследовать свою идентичность\n• Найти настоящие глубокие связи\n• Получить поддержку группы\n• Открыть новые грани себя\n\nГруппа единомышленниц на пути к себе.`,
        button: 'Узнать о программе "Кто я?"',
    ...
    return {
      text: `🌱 **Продвинутые практики**\n\nТы готова к следующему уровню! Для тебя подойдут:\n\n• Мини-курсы по эмоциональному интеллекту\n• Практики работы с границами\n• Углубление в женственность\n• Развитие навыков отношений\n\nВыбирай то, что откликается больше всего.`,
      button: 'Посмотреть все практики',
  ...
  private async handleRecommendationClick(chatId: number, data: string): Promise<void> {
    ...
    switch (recommendationType) {
      case 'individual':
        message = `💆 **Индивидуальная консультация**\n\n` +
          `🔹 Длительность: 50 минут\n` +
          `🔹 Формат: Онлайн или очно\n` +
          `🔹 Что входит: Диагностическая беседа, персональные рекомендации, план работы\n\n` +
          `Для записи напиши @amalinovskaya_psy`;
        break;
      case 'course_mind':
        message = `🧭 **Курс "Тихий ум"**\n\n` +
          `🔹 Длительность: 6 недель\n` +
          `🔹 Формат: Групповые встречи + материалы\n` +
          `🔹 Что изучаем: Работа с тревогой, самооценка, внутренний критик\n\n` +
          `Следующий поток стартует скоро. Напиши для деталей!`;
        break;
      case 'group_identity':
        message = `🔎 **Программа "Кто я?"**\n\n` +
          `🔹 Длительность: 8 недель\n` +
          `🔹 Формат: Группа до 8 человек\n` +
          `🔹 Что исследуем: Идентичность, роли, ценности, смыслы\n\n` +
          `Глубокая трансформационная работа в поддерживающей группе.`;
        break;
      case 'advanced':
        message = `🌱 **Продвинутые практики**\n\n` +
          `🔹 Эмоциональный интеллект (2 недели)\n` +
          `🔹 Здоровые границы (3 недели)\n` +
          `🔹 Женская сила и мудрость (4 недели)\n` +
          `🔹 Искусство отношений (3 недели)\n\n` +
